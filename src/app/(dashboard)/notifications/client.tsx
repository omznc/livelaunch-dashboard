    ...
    <div className="flex flex-col gap-4">
      <SettingGroup title={'Notifications'} description={'Settings for the notification feature.'}>
        ...
        <Setting
          ...
          description={'Choose which channel the bot should send notifications to. Setting this enables this feature.'}
          active={false}
        >
          <Select
            onValueChange={value => {
      ...
      <SettingGroup title={'General Filtering'} description={'Other filters that can be applied to notifications.'}>
        <Setting
          label={'T-0 Change'}
